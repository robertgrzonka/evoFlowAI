...
const C = {
  en: {
    ...
    quickMeal: 'Quick log meal',
    quickMealSummary: 'Describe what you ate — Evo estimates macros and saves to today.',
    quickMealPlaceholder: 'e.g. omelette with vegetables and rye bread',
    loggingMeal: 'Saving meal…',
    addMealQuick: 'Save with Evo',
    ...
    stepsCountRequired: 'Enter today’s step count (0–120000).',
    invalidWorkoutMinutes: 'Duration must be at least 1 minute.',
    invalidWorkoutCalories: 'Calories burned must be 0 or more.',
  ...
  pl: {
    ...
    quickMealSummary: 'Krótki opis — Evo oszacuje makra i zapisze na dziś.',
    quickMealPlaceholder: 'Np. omlet z warzywami i chleb żytni',
    loggingMeal: 'Zapisywanie posiłku…',
    addMealQuick: 'Zapisz z Evo',
    ...
    stepsCountRequired: 'Podaj liczbę kroków (0–120000).',
    invalidWorkoutMinutes: 'Czas trwania: min. 1 minuta.',
    invalidWorkoutCalories: 'Spalone kcal muszą być ≥ 0.',
